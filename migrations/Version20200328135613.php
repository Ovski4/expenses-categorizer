 ...
 */
final class Version20200328135613 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sub_category (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', top_category_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, INDEX IDX_BCE3F798C601200 (top_category_id), UNIQUE INDEX sub_category_unique (name, top_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sub_category_transaction_rule (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', sub_category_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', contains VARCHAR(255) NOT NULL, INDEX IDX_2761B910F7BFE87C (sub_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
